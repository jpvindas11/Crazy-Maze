...
void Menu_draw::load_all(SDL_Renderer* ren){
    ...
    player1_overlay.init("assets/menu/selection/selec_player.png",ren,0,0,(PLAYER_OVER_WIDTH-PLAYER_OVER_WIDTH/2),(screen_height/2)-(PLAYER_OVER_HEIGHT/2),
    ...
    player2_overlay.init("assets/menu/selection/selec_player.png",ren,0,0,(screen_width - PLAYER_OVER_WIDTH*1.5),(screen_height/2)-(PLAYER_OVER_HEIGHT/2),
...
void Menu_draw::update(int game_state, int p1_skin, int p2_skin, int map_index){
